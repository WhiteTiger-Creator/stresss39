...
tie-breaking order, the stopping conditions, the leaf values, the JSON node shapes, and the
canonical SHA-256 hashing used for the checksums — is defined in full in
`/app/docs/tree_spec.md`. Follow it exactly.
